...
<div class="my-3">
    ...
    <form action="{{ route('order.storeorder') }}" id="sparepartorder" class="bg-white shadow-sm p-3" method="POST"
        ...
        <div class="form-group">
           ...
           <span class="text-danger">{{ $errors->first('hull_code') }}</span>
       </div>
